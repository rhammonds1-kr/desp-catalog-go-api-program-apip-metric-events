 ...
 *     EventHeader.avsc
 */
package api_program_apip_metric_events
...
type DefaultEventCreated struct {
	...
	NewField3 string `json:"newField3"`

	NewField4 bool `json:"newField4"`
}

const DefaultEventCreatedAvroCRC64Fingerprint = "Yu\x8e\x9d\xd9\x12&\xed"
...
func writeDefaultEventCreated(r DefaultEventCreated, w io.Writer) error {
	...
	err = vm.WriteString(r.NewField3, w)
	if err != nil {
		return err
	}
	err = vm.WriteBool(r.NewField4, w)
	if err != nil {
		return err
	}
	return err
...
func (r DefaultEventCreated) Schema() string {
	return "{\"fields\":[{\"doc\":\"Example: This is a sample attribute, please edit.\",\"name\":\"sample\",\"type\":\"string\"},{\"default\":null,\"doc\":\"\",\"name\":\"newField1\",\"type\":[\"null\",{\"avro.java.string\":\"String\",\"type\":\"string\"}]},{\"default\":null,\"doc\":\"\",\"name\":\"newField2\",\"type\":[\"null\",{\"avro.java.string\":\"String\",\"type\":\"string\"}]},{\"default\":\"abc\",\"doc\":\"\",\"name\":\"newField3\",\"type\":{\"avro.java.string\":\"String\",\"type\":\"string\"}},{\"default\":false,\"doc\":\"\",\"name\":\"newField4\",\"type\":\"boolean\"}],\"name\":\"com.kroger.desp.events.apiprogram.apip-metric-events.DefaultEventCreated\",\"type\":\"record\"}"
}

func (r DefaultEventCreated) SchemaName() string {
	return "com.kroger.desp.events.apiprogram.apip-metric-events.DefaultEventCreated"
}
...
func (r *DefaultEventCreated) Get(i int) types.Field {
	...
	case 2:
		...
		return r.NewField2
	case 3:
		return &types.String{Target: &r.NewField3}
	case 4:
		return &types.Boolean{Target: &r.NewField4}
	}
...
func (r DefaultEventCreated) MarshalJSON() ([]byte, error) {
	...
	output["newField3"], err = json.Marshal(r.NewField3)
	if err != nil {
		return nil, err
	}
	output["newField4"], err = json.Marshal(r.NewField4)
	if err != nil {
		return nil, err
	}
...
func (r *DefaultEventCreated) UnmarshalJSON(data []byte) error {
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.NewField3); err != nil {
			return err
		}
	} else {
		r.NewField3 = "abc"
	...
	if val != nil {
		if err := json.Unmarshal([]byte(val), &r.NewField4); err != nil {
			return err
		}
	} else {
		r.NewField4 = false
